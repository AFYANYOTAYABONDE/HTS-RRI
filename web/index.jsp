                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="width:100%;">
                            <form class="form form-vertical" action="#" method="post" id="weeklydataform">
                                ...
                                <tr><th style="text-align:center"><b>Enter Daily HTS Data</b></th></tr>
<!--                                <tr><td class="col-xs-12">
                                ...
                                <tr><td class="col-xs-12">
                                  ...
                                  <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select  onchange="settargets();checkids();"   name="facilityname" id="facilityname" class="form-control" >
...
//load data from the cloud server 
   ...
   getFacilitiesJson();
    ...
    var userdb = new PouchDB('counsellordetails');
...
var targetsdb = new PouchDB('targets_rri');
var remoteCouch = false;
var receivedtargets;
                 ...
                 //alert(data[0].facility_name);    
                     for(var i=0;i<data.length;i++){
                       ...
                       // console.log(data[i].facility_name) 
                        ...
                        addtargets(data[i].id,data[i].mflcode,data[i].year,data[i].positive_tg,data[i].treatment_tg,data[i].viralload_tg,data[i].timestamp,data[i].weeks);
                        updatetargets(data[i].id,data[i].mflcode,data[i].year,data[i].positive_tg,data[i].treatment_tg,data[i].viralload_tg,data[i].timestamp,data[i].weeks);
